...
import { OpenAICompatProvider, openaiSchemaAdapter } from "@lwrf42/emerge-provider-openai-compat";
import type { OpenAIProtocol, OpenAIReasoningConfig } from "@lwrf42/emerge-provider-openai-compat";
